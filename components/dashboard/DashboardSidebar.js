...
export default function DashboardSidebar({ activePanel, setActivePanel }) {
    ...
    return (
        <aside className="w-64 bg-neutral-900 border-r border-neutral-800 h-screen">
            <div className="p-6">
                <Link href="/" className="text-xl font-bold text-primary hover:text-primary/80 transition-colors flex items-center">
                    FocusFast
                </Link>
            </div>
