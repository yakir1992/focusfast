...
import logo from "@/app/new-logo.png";
...
const Header = () => {
  ...
  return (
    <header className="bg-base-200 fixed top-0 left-0 right-0 z-50">
      <nav
        ...
        <div className="flex lg:flex-1">
          ...
          >
            <Image
              ...
              height={32}
            />
            <span className="font-extrabold text-lg text-orange-500">{config.appName}</span>
          </Link>
        </div>
